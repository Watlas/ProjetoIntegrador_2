 ...
 * @author roger
 */
public class TelaCadSugestao extends javax.swing.JFrame {

    Sugestao sugestao;
    Sugestao sugestaoAnterior;
    SugestaoControle controle;

    /**
     * Creates new form TelaSugestoes
     */
    public TelaCadSugestao() throws Exception {
        initComponents();
        ...
        UsuarioControle usuario = new UsuarioControle("Usuarios.txt");
        ...
        imprimirSugestoes(controle.recuperar());
    }
    ...
    private void initComponents() {
        ...
        jButtonListaDeSugestões = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("SISTEMA CONTROLE DE BIBLIOTECA");
        setResizable(false);

        jLabel1.setText("SUGESTÕES PARA AQUISIÇÕES DE LVIROS");
        ...
        if (jTableSugestao.getColumnModel().getColumnCount() > 0) {
            jTableSugestao.getColumnModel().getColumn(0).setMinWidth(60);
            jTableSugestao.getColumnModel().getColumn(0).setMaxWidth(60);
            jTableSugestao.getColumnModel().getColumn(1).setMinWidth(0);
            jTableSugestao.getColumnModel().getColumn(1).setMaxWidth(0);
            jTableSugestao.getColumnModel().getColumn(3).setMinWidth(0);
            jTableSugestao.getColumnModel().getColumn(3).setMaxWidth(0);
            jTableSugestao.getColumnModel().getColumn(4).setMinWidth(0);
            jTableSugestao.getColumnModel().getColumn(4).setMaxWidth(0);
        }
        ...
        jButtonListaDeSugestões.setText("LISTAGEM");
        jButtonListaDeSugestões.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonListaDeSugestõesActionPerformed(evt);
            }
        });
        ...
        jPanelSugestoesLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelSugestoesLayout.createSequentialGroup()
                ...
                .addGroup(jPanelSugestoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelSugestoesLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanelSugestoesLayout.createSequentialGroup()
                        .addGroup(jPanelSugestoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelSugestoesLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jButtonListaDeSugestões)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanelSugestoesLayout.setVerticalGroup(
            ...
            .addGroup(jPanelSugestoesLayout.createSequentialGroup()
                ...
                .addGap(33, 33, 33)
                .addGroup(jPanelSugestoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jFormattedTextFieldDataSugestao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(20, 20, 20)
    ...
    private void jButtonIncluirSugestaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirSugestaoActionPerformed
        ...
        if (jFormattedTextFieldDataSugestao.getText().trim().replaceAll("/", "").equals("")) {
            ...
            try {
                ...
                controle.incluir(sugestao);
                limpaCampos();
                desabilitaCampos();
                imprimirSugestoes(controle.recuperar());

            } catch (Exception erro) {
                JOptionPane.showMessageDialog(null, "Ocorrreu um erro ao incluir esta sugestão!\n" + erro);
            }
        }
        jFormattedTextFieldDataSugestao.requestFocus();
    ...
    private void jButtonListaDeSugestõesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListaDeSugestõesActionPerformed
        TelaListaDeSugestões tela = new TelaListaDeSugestões();
        tela.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButtonListaDeSugestõesActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadSugestao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TelaCadSugestao().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(TelaCadSugestao.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JButton jButtonListaDeSugestões;
