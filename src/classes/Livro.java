...
public class Livro implements Comparable<Livro> {
    ...
    public Livro(String isbn, String tituloLivro, String subTituloLivro, Autor autor,
            Editora editora, AreaDoLivro area, String edicao, int anoDePublicacao) throws Exception {
        this.isbn = isbn;
    ...
    public Livro(String strDadosLivro) throws Exception {
        ...
        ICRUDautor controleAutor = new AutorControle("Autores.txt");
        autor = controleAutor.buscarPeloId(Integer.parseInt(vetorLivro[4]));
        ICRUDeditora controleEditora = new EditoraControle("Editoras.txt");
        editora = controleEditora.buscarId(Integer.parseInt(vetorLivro[5]));
        ICRUDareaDoLivro controleArea = new AreaControle("Areas.txt");
    ...
    public AreaDoLivro getArea() {
        return area;
    }

    public void setArea(AreaDoLivro area) {
        this.area = area;
    }
